        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm border-double border-4 pl-3 pr-3 pb-3">
            <form action="{{ route('chat.join', ['unique_name' => $chat->unique_name]) }}" method="post"
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input name="username" type="text" required class="block w-full rounded-md border-0
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input name="password" type="password" required class="block w-full rounded-md border-0
                            py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400
                            focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6
                            ">
                    </div>
